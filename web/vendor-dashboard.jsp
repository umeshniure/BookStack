<%-- 
    ...
    Created on : Aug 28, 2022, 12:14:16 PM
    Author     : Umesh
--%>
                        ...
                        <div class="h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                            ...
                            <div>
                                ...
                                <div class="mt-2 flex justify-center gap-4">
                                    <h3 class="text-3xl font-bold text-gray-700">NPR. 23,988</h3>
                                ...
                                <span class="block text-center text-gray-500">Compared to last week NPR. 13,988</span>
                            </div>
                    ...
                    <div>
                        <div class="h-full py-6 px-6 rounded-xl border border-gray-200 bg-white">
                            ...
                            <div class="my-8">
                                ...
                                <span class="text-gray-500">Compared to last week NPR. 13,988</span>
                            </div>
