        ...
        <c:if test="${sessionScope.id != null}">
            ...
            <div class="flex md:order-2 space-x-5 items-center">
                ...
                <div class="flex -space-x-2 overflow-hidden">
                    <img  data-popover-target="popover-user-profile" class="inline-block h-10 w-10 rounded-full ring-2 ring-white" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">

                        <!--profile cards-->
                        <div data-popover id="popover-user-profile" role="tooltip" class="inline-block absolute invisible z-40 w-64 text-sm font-light text-gray-500 bg-white rounded-lg border border-gray-200 shadow-sm opacity-0 transition-opacity duration-300 dark:text-gray-400 dark:bg-gray-800 dark:border-gray-600">
                            <div class="p-3">
