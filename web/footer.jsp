...
<footer class="bg-white pt-20 lg:pt-10 pb-10 lg:pb-10 relative z-10 px-10 border-t">
    <div class="flex justify-center">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full sm:w-2/3 lg:w-3/12 px-4">
                <div class="w-full mb-10">
                    <div class="flex w-full justify-center">
                        <a href="home" class="inline-block max-w-[160px] mb-6">
                            <img src="./images/static/bookstack_logos/bookstack-logo.png" alt="Bookstack" class="max-w-full w-24 h-auto"/>
                        </a>
                    </div>
                    <p class="text-base text-body-color mb-7">
                        BookStack is an online platform which allows different sellers sell their book online
                        and grow their business more. Our aim is to provide quality service to our user, make them easy to 
                        surf and buy all kinds of books and the lowest price.
                    </p>
    ...
    <div>
        <span class="absolute left-0 bottom-0 z-[-1]">
            ...
            <linearGradient
                ...
                >
            <stop stop-color="#3056D3" stop-opacity="0.31" />
