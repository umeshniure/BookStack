            ...
            <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 shadow-7-strong">
                <div class="relative flex items-center justify-between h-16">
                    ...
                    <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        <button type="button" class="bg-purple-600 p-1 rounded-full text-gray-400 hover:text-white focus:outline-purple focus:ring-2 focus:text-white focus:ring-offset-2 focus:ring-offset-gray-400 focus:ring-white">
                        ...
                        <button type="button" class="ml-3 bg-purple-600 p-1 rounded-full text-gray-400 hover:text-white focus:outline-purple focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-400 focus:ring-white">
