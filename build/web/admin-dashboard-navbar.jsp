...
<c:if test="${sessionScope.errorMessage != null}">
    <div id="toast-warning" class="flex absolute top-9 right-5 items-center p-4 w-full max-w-lg text-white bg-red-400 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
<c:if test="${sessionScope.successMessage != null}">
    <div id="toast-success" class="flex absolute top-10 mt-4 right-0 items-center p-4 mb-4 w-full max-w-lg text-white bg-green-400 rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
...
<div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
    ...
    <div class="flex pl-1 justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
